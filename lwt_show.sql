...
--
-- Host: localhost
-- Generation Time: Jan 29, 2014 at 07:32 PM
...
--
-- Database: `lwt_new_show`
--
CREATE DATABASE IF NOT EXISTS `lwt_new_show` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `lwt_new_show`;
...
CREATE TABLE IF NOT EXISTS `languages` (
  ...
  `sizeLeft` int(11) NOT NULL DEFAULT '100000',
  `splitSize` int(11) NOT NULL DEFAULT '5',
  PRIMARY KEY (`LgID`),
...
CREATE TABLE IF NOT EXISTS `texts` (
  ...
  `TxTranslation` text NOT NULL,
  `sizeBytes` int(11) NOT NULL,
  `frases_saved` int(11) NOT NULL,
  PRIMARY KEY (`TxID`),
  KEY `TxLgID` (`TxLgID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
INSERT INTO `texttags` (`TtTxID`, `TtT2ID`) VALUES
(39, 10),
(40, 10),
(41, 10),
(42, 10),
...
CREATE TABLE IF NOT EXISTS `users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `phash` varchar(128) COLLATE utf8_bin NOT NULL,
  `session` varchar(128) COLLATE utf8_bin NOT NULL,
  `exe_quota` int(11) NOT NULL DEFAULT '50000',
  `text_quota` int(11) NOT NULL DEFAULT '1000000',
  `username` varchar(25) COLLATE utf8_bin NOT NULL,
  `active_language` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=1 ;
...
INSERT INTO `users` (`id`, `phash`, `session`, `exe_quota`, `text_quota`, `username`, `active_language`) VALUES
(0, 'lwt', '1741bb7d3637692c0770f70090580dca8b5c0f96', 50000, 1000000, 'lwt', 5);
